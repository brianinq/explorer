...
if (isset($_POST['submit'])) {
    ...
    if(empty($title)){
        ...
        //insert to db
        global $connection;
        $sql = "INSERT INTO posts(title, category,author, image, body, timestamp) VALUES(:title, :category, :author, :image, :body, :timestamp )";
        ...
        if ($execute){
            $_SESSION['successMessage'] = "Post ".$title." Added Successfully";
            redirect("createPost.php");
        } else{
...
<header class="bg-dark text-white py-4">
    <div class="container">
        <div class="row col-md-12">
            <h1><i class="fas fa-edit text-primary"></i> Create New Blog Post</h1>
        </div>
    </div>
</header>
...
<section class="container py-2 mb-4">
    <div class="row">
        <div class="col-lg-10 offset-lg-1" style="min-height: 450px">
            ...
            <form action="createPost.php" method="post" class="" enctype="multipart/form-data">
                <div class="card bg-dark text-light mb-3">
                    <div class="card-body mb-3">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <textarea class="form-control" name="postBody" id="postBody" cols="30" rows="10"></textarea>
                        </div>
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6 d-grid mb-2">
                                <button class="btn btn-lg btn-success btn-block" type="submit" name="submit"><i
                                            class="fas fa-check"></i> Publish Blog
                                </button>
                            </div>
                        </div>
                    </div>
